      ...
      return L.circleMarker(latlng, {
          ...
          fillOpacity: .35
            ...
            mouseover: function(e) {
                this.openPopup();
                this.setStyle({fillOpacity: .8, fillColor: '#00b4d8'});

            },
            mouseout: function(e) {
                this.closePopup();
                this.setStyle({fillOpacity: .35, fillColor: '#03045e'});  
            }
    });
  }
});
...
var searchControl = new L.Control.Search({
    ...
    delayType: 30,
    collapsed: false,
    textPlaceholder: 'Search by Peak Name: e.g. Everest',   
